...
function Slide1(){
    ...
    */
    ...
    document.getElementById( "prev" ).setAttribute( "onClick", "javascript: Slide3();" );
    document.getElementById( "next" ).setAttribute( "onClick", "javascript: Slide2();" );
}
...
function Slide2(){
    ...
    /*
    document.getElementById("youtubevid").src = "https://www.youtube.com/embed/wwH3fygSNVU";
    */
    ...
    document.getElementById( "prev" ).setAttribute( "onClick", "Slide1();" );
    document.getElementById( "next" ).setAttribute( "onClick", "Slide3();" );
}
...
function Slide3(){
    ...
    */
    ...
    document.getElementById( "prev" ).setAttribute( "onClick", "javascript: Slide2();" );
    document.getElementById( "next" ).setAttribute( "onClick", "javascript: Slide1();" );
}
...
function change_imgtotext3() {
   var node = document.getElementById('svgcontainer3');
    ...
    var node = document.getElementById('exitbtn2');
    node.style.visibility= 'visible'
    var node = document.getElementById('hawksbillinfo');
    node.style.visibility= 'visible'

    document.getElementById('slide3title').setAttribute("class", "showslide3titleb");
    document.getElementById('stellertitle').setAttribute("class", "style2");  
    document.getElementById('hawksbillinfo').setAttribute("class", "hawksbillinfoadjust");  
...
function backtoimg3(){
    ...
    var node = document.getElementById('hawksbillinfo');
    node.style.visibility= 'hidden'
    var node = document.getElementById('hawksbillgraph');
    node.style.visibility= 'hidden'
...
function change_imgtostats3(){
    ...
    document.getElementById('hawksbillgraph').setAttribute("class", "style3c");
