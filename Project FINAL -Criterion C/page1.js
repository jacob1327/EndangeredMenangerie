...
function Slide1(){
    ...
    node.style.visibility= 'hidden'
    var node = document.getElementById("malayantitle");
    node.style.visibility= 'hidden'

    document.getElementById('amurtitle').setAttribute("class", "showslide1title");
...
function Slide2(){
    ...
    var node = document.getElementById("malayantitle");
    node.style.visibility= 'visible'
    var node = document.getElementById('malayaninfo');
    node.style.visibility= 'hidden'  

    document.getElementById('malayantitle').setAttribute("class", "showmalayantitle");
...
function change_imgtotext2() {
    ...
    document.getElementById('malayaninfo').setAttribute("class", "malayaninfoadjust");
    document.getElementById('malayantitle').setAttribute("class", "style2");   
...
function backtoimg2(){
    ...
    var node = document.getElementById('malayaninfo');
    node.style.visibility= 'hidden'
    var node = document.getElementById('malayangraph');
    node.style.visibility= 'hidden'

    document.getElementById('malayantitle').setAttribute("class", "reset"); 
}
...
function change_imgtostats2(){
    ...
    document.getElementById('malayangraph').setAttribute("class", "style3b");
    document.getElementById('malayantitle').setAttribute("class", "style2b");  
